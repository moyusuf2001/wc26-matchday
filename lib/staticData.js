...
// Both games in each group are played simultaneously — the group stage finale.
export const M3 = [
 // ── Tuesday, June 24 — Groups A & B ─────────────────────────────────────────
 {d:"Tue Jun 24",ds:"Tuesday, June 24",t:"3:00",z:"PM ET",grp:"A",h:"RSA",a:"KOR",v:"NRG Stadium",c:"Houston",fav:"a",conf:"lean",
 ...
 {d:"Tue Jun 24",ds:"Tuesday, June 24",t:"3:00",z:"PM ET",grp:"A",h:"CZE",a:"MEX",v:"AT&T Stadium",c:"Arlington, TX",fav:"a",conf:"lean",
 ...
 {d:"Tue Jun 24",ds:"Tuesday, June 24",t:"9:00",z:"PM ET",grp:"B",h:"BIH",a:"QAT",v:"BMO Field",c:"Toronto",fav:"h",conf:"high",
 ...
 {d:"Tue Jun 24",ds:"Tuesday, June 24",t:"9:00",z:"PM ET",grp:"B",h:"SUI",a:"CAN",v:"BC Place",c:"Vancouver",fav:"x",conf:"toss",
 ...
 // ── Wednesday, June 25 — Groups C & D ────────────────────────────────────────
 {d:"Wed Jun 25",ds:"Wednesday, June 25",t:"3:00",z:"PM ET",grp:"C",h:"MAR",a:"HAI",v:"Lumen Field",c:"Seattle",fav:"h",conf:"high",
 ...
 {d:"Wed Jun 25",ds:"Wednesday, June 25",t:"3:00",z:"PM ET",grp:"C",h:"SCO",a:"BRA",v:"Gillette Stadium",c:"Foxborough, MA",fav:"a",conf:"high",
 ...
 {d:"Wed Jun 25",ds:"Wednesday, June 25",t:"9:00",z:"PM ET",grp:"D",h:"PAR",a:"AUS",v:"Levi's Stadium",c:"Santa Clara, CA",fav:"x",conf:"toss",
 ...
 {d:"Wed Jun 25",ds:"Wednesday, June 25",t:"9:00",z:"PM ET",grp:"D",h:"TUR",a:"USA",v:"Mercedes-Benz Stadium",c:"Atlanta",fav:"a",conf:"lean",
 ...
 // ── Thursday, June 26 — Groups E & F ─────────────────────────────────────────
 {d:"Thu Jun 26",ds:"Thursday, June 26",t:"3:00",z:"PM ET",grp:"E",h:"CUW",a:"CIV",v:"Hard Rock Stadium",c:"Miami Gardens",fav:"a",conf:"high",
 ...
 {d:"Thu Jun 26",ds:"Thursday, June 26",t:"3:00",z:"PM ET",grp:"E",h:"ECU",a:"GER",v:"SoFi Stadium",c:"Inglewood, CA",fav:"a",conf:"lean",
 ...
 {d:"Thu Jun 26",ds:"Thursday, June 26",t:"9:00",z:"PM ET",grp:"F",h:"JPN",a:"SWE",v:"Arrowhead Stadium",c:"Kansas City",fav:"x",conf:"toss",
 ...
 {d:"Thu Jun 26",ds:"Thursday, June 26",t:"9:00",z:"PM ET",grp:"F",h:"TUN",a:"NED",v:"Lincoln Financial Field",c:"Philadelphia",fav:"a",conf:"high",
 ...
 // ── Friday, June 27 — Groups G & H ───────────────────────────────────────────
 {d:"Fri Jun 27",ds:"Friday, June 27",t:"3:00",z:"PM ET",grp:"G",h:"EGY",a:"IRN",v:"Estadio Akron",c:"Guadalajara",fav:"x",conf:"toss",
 ...
 {d:"Fri Jun 27",ds:"Friday, June 27",t:"3:00",z:"PM ET",grp:"G",h:"BEL",a:"NZL",v:"Estadio BBVA",c:"Monterrey",fav:"h",conf:"high",
 ...
 {d:"Fri Jun 27",ds:"Friday, June 27",t:"9:00",z:"PM ET",grp:"H",h:"CPV",a:"KSA",v:"Estadio Azteca",c:"Mexico City",fav:"a",conf:"lean",
 ...
 {d:"Fri Jun 27",ds:"Friday, June 27",t:"9:00",z:"PM ET",grp:"H",h:"ESP",a:"URU",v:"AT&T Stadium",c:"Arlington, TX",fav:"h",conf:"lean",
  why:"Spain against Uruguay is the premium fixture of MD3. After the Cape Verde shock and the Saudi Arabia demolition, this is Spain's real test. Valverde and Núñez make Uruguay the stiffest opponent Spain face before the knockouts.",
  take:{
    ...
    sections:[
      {h:"Spain's identity question",p:"The 0–0 draw with Cape Verde raised a legitimate question: can Spain unlock a low block? Their system is built on possession, patience and Yamal's brilliance on the right, but against teams who sit deep and defend compactly, the passing can become horizontal and the chances sparse. Uruguay will not press high — they will sit in shape and invite Spain onto them, then spring Núñez and Valverde on the counter. Spain have to find answers they didn't have against Cape Verde."},
      {h:"Uruguay's counter threat",p:"Bielsa's Uruguay are one of the most dangerous counter-attacking teams in the tournament. Valverde drives from deep with genuine pace and quality, Núñez in behind is a constant threat on the shoulder of the last defender, and the two banks of four are organised and compact. They beat Saudi Arabia comfortably and will come here with genuine belief. The goal is to make Spain play long and slow, absorb pressure, and exploit the space behind Spain's high line on the transition."},
      {h:"The Yamal factor",p:"Lamine Yamal at 18 is still the wildcard nobody quite knows how to solve. His ability to receive in tight spaces and accelerate past two players in a single movement is the one thing that makes Spain unpredictable against a deep defence. If Uruguay's left side struggles to contain him, the whole match changes. Oyarzabal's movement in the box and Pedri's passing from deep are the two other mechanisms Spain rely on when the game gets tight."}
    ],
    verdict:"Spain should win this but it will be earned. Uruguay will make them work for every inch. My call is 2–1 Spain after a difficult first hour, with a late goal from Yamal or Oyarzabal settling it. If Uruguay score first, the game opens up entirely and either side can win it."
  }},

 // ── Saturday, June 28 — Groups I & J ─────────────────────────────────────────
 {d:"Sat Jun 28",ds:"Saturday, June 28",t:"3:00",z:"PM ET",grp:"I",h:"SEN",a:"IRQ",v:"BMO Field",c:"Toronto",fav:"h",conf:"lean",
  why:"Senegal need a win to secure second in Group I. Iraq are eliminated but have defensive resilience. Jackson's pace in behind and Sarr's intensity in midfield should be enough for Senegal to see this through."},
 {d:"Sat Jun 28",ds:"Saturday, June 28",t:"3:00",z:"PM ET",grp:"I",h:"NOR",a:"FRA",v:"Gillette Stadium",c:"Foxborough, MA",fav:"a",conf:"lean",
  why:"The match of Matchday 3. Haaland's Norway against Mbappé's France for Group I top spot. Both sides likely already qualified. Norway at home energy vs France's frightening firepower — the most anticipated fixture of the group stage finale.",
  take:{
    standfirst:"This is the game everyone wanted to see at the start of the group stage: Haaland vs Mbappé, Norway's physicality against France's artistry, a clash of two completely different visions of how to play winning football. Both are already through. Neither side will rotate. They both want to win this.",
    sections:[
      {h:"Norway's direct machine",p:"Solbakken's Norway have one game plan and they execute it with ruthless clarity. Win the ball back quickly, move it forward fast through Ødegaard, and deliver into the channels for Haaland. The 4–1 win over Iraq was the template: control the midfield battle, don't give cheap balls away, and let Haaland's movement and finishing do the rest. France's defensive line will be tested aerially and on the recovery run — Haaland's 16 qualifying goals were not a fluke."},
      {h:"France's creative threat",p:"Deschamps has Mbappé at full speed, Dembélé creating from the right, and Olise as the third creative option in a midfield that generates overloads all over the pitch. France's biggest advantage is their ability to press high and win the ball in dangerous positions. If they can stop Norway from building through Ødegaard and force long balls that don't find Haaland, they win the midfield battle and the game opens up for their attacking players."},
      {h:"The Ødegaard question",p:"The most important individual battle is Martin Ødegaard against France's midfield press. Norway's entire build-up runs through him. If France can isolate Ødegaard and prevent him from receiving and turning, Norway are reduced to direct, predictable football that France's centre-backs can manage. But if Ødegaard finds pockets and plays the switches to Haaland's runs, Norway have enough to trouble any defence in the tournament."}
    ],
    verdict:"France win this, but not comfortably. Haaland will cause problems and Norway will make it physical and competitive for 70 minutes. Then Mbappé finds the decisive moment — the type of run in behind that no right-back in the tournament has yet found an answer to. France 2–1, Haaland with a goal, Mbappé with two."
  }},
 {d:"Sat Jun 28",ds:"Saturday, June 28",t:"9:00",z:"PM ET",grp:"J",h:"AUT",a:"ALG",v:"Levi's Stadium",c:"Santa Clara, CA",fav:"x",conf:"toss",
  why:"Austria and Algeria face off with third-place qualification on the line. Rangnick's pressing system against Algeria's creative threat through Mahrez and Amoura is a fascinating tactical clash with enormous stakes for both sides."},
 {d:"Sat Jun 28",ds:"Saturday, June 28",t:"9:00",z:"PM ET",grp:"J",h:"ARG",a:"JOR",v:"Arrowhead Stadium",c:"Kansas City",fav:"h",conf:"high",
  why:"Argentina, defending champions and already through after Messi's hat-trick, face Jordan's debutants in the group finale. The Albiceleste will want to send a statement to the knockouts. Jordan will want to give their fans something to remember."},

 // ── Sunday, June 29 — Groups K & L ────────────────────────────────────────────
 {d:"Sun Jun 29",ds:"Sunday, June 29",t:"3:00",z:"PM ET",grp:"K",h:"COD",a:"UZB",v:"MetLife Stadium",c:"East Rutherford, NJ",fav:"h",conf:"lean",
  why:"DR Congo against Uzbekistan is a potential elimination battle. Both sides drew in MD1 (Portugal 1–1 Congo) and Congo showed genuine quality. A fascinating battle between two debutant-adjacent nations with real stakes."},
 {d:"Sun Jun 29",ds:"Sunday, June 29",t:"3:00",z:"PM ET",grp:"K",h:"POR",a:"COL",v:"SoFi Stadium",c:"Inglewood, CA",fav:"h",conf:"lean",
  why:"Portugal versus Colombia decides Group K. After the shock 1–1 draw with DR Congo, Ronaldo and Portugal need a win. James Rodríguez and Luis Díaz make Colombia genuinely dangerous. The pressure on Portugal's squad — and on their captain — is real.",
  take:{
    standfirst:"This is Ronaldo's final chance to shape his last World Cup into a story worth telling. Portugal dropped points they cannot afford against DR Congo. A second stumble means potential elimination. Colombia, with James Rodríguez pulling strings and Luis Díaz's pace on the flank, are not here to make it easy.",
    sections:[
      {h:"Ronaldo and the weight of the moment",p:"At 41, at his sixth and certainly last World Cup, Cristiano Ronaldo goes into this match without a goal from the group stage. The narrative writes itself but football doesn't care about narratives. The question is whether Martinez plays Ronaldo in a system that creates chances for him, or whether Portugal's best route to victory actually runs through Bruno Fernandes's creativity and the supporting attackers who are in better form. The captain needs this and Portugal need his best."},
      {h:"Colombia's attacking threat",p:"James Rodríguez orchestrating from a deeper role, Luis Díaz with genuine pace on the left, and a midfield that can press and win second balls. Colombia have the quality to hurt a Portugal side that has not been completely convincing. Their game plan will be to press high, force Portugal's centre-backs into long balls, and use Díaz's runs in behind to create the chances. They are not here to park the bus."},
      {h:"Portugal's route to winning",p:"Bruno Fernandes has to control the tempo from the number ten position and find Ronaldo in the right moments. Nuno Mendes attacking from left-back is Portugal's most consistent creative outlet. The key is whether Portugal can move the ball quickly enough to break Colombia's press before it becomes suffocating. If they can do that in the first 20 minutes and take the lead, Ronaldo's experience and Fernandes's delivery can see them through."}
    ],
    verdict:"Portugal win this but it is not comfortable. A Ronaldo goal would complete the story, but Portugal win it through Bruno's creativity and collective quality rather than one individual moment. My call: Portugal 2–1 Colombia with Colombia making them work for every second of it."
  }},
 {d:"Sun Jun 29",ds:"Sunday, June 29",t:"9:00",z:"PM ET",grp:"L",h:"CRO",a:"GHA",v:"Levi's Stadium",c:"Santa Clara, CA",fav:"h",conf:"lean",
 ...
 {d:"Sun Jun 29",ds:"Sunday, June 29",t:"9:00",z:"PM ET",grp:"L",h:"ENG",a:"PAN",v:"Estadio Azteca",c:"Mexico City",fav:"h",conf:"high",
  why:"England versus Panama is England's most winnable group fixture. Kane, Bellingham and Saka against a Panama side who defend deep and compete hard. England should win this comfortably, advance in style, and send a message heading into the knockouts."},
];
