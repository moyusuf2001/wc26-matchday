...
export const TOURNAMENT_THEMES = [
  ...
  { kind: 'favourite-dominant', label: 'Spain: ruthless',          pick: '4–0 Saudi Arabia. A statement from the favourites.', detail: "Spain dismantled Saudi Arabia 4–0 in what was the most one-sided result of Matchday 2. Spain are scoring at will, conceding nothing, and playing with a confidence that only the best teams carry. The tournament favourite is performing like one.", tone: 'gold' },
