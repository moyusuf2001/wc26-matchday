...
export const TOURNAMENT_THEMES = [
  ...
  { kind: 'living-legend',      label: "Messi won't go quietly",   pick: 'A goal, two assists. The defending champions look ominous.', detail: "Argentina 3–1 Algeria. At 38, Messi drops deeper but still finds the decisive pass, the late run, the moment nobody else sees. The defending champions look dangerous again — and he is still the reason why.", tone: 'gold' },
  { kind: 'best-player',        label: "Germany's ceiling",        pick: 'Wirtz is the best player at this tournament.', detail: "Two goals vs Curaçao. Man of the match vs Ivory Coast in a 2–1 win. The Wirtz–Musiala axis is the most cohesive creative unit in the field. Germany have won both games and haven't been at full tilt yet.", tone: 'gold' },
  { kind: 'favourite-dominant', label: 'Spain: ruthless',          pick: '7 goals. 0 conceded. Already qualified.',      detail: "Three past Cape Verde. Four past Saudi Arabia. Yamal with three assists across both games, Oyarzabal on the scoresheet in both. Spain wrapped up Group H qualification with a game to spare. The tournament favourite is performing above that standard.", tone: 'gold' },
  { kind: 'upset-artist',       label: 'Atlas Lions strike again', pick: 'Morocco making life uncomfortable.',           detail: "Brazil survived them in MD1 — just. Scotland fell 2–1 in MD2, Hakimi the architect. Morocco are a win away from the Round of 32 and every remaining Group C opponent is uncomfortable sharing a group with them. The 2022 semifinalists are back.", tone: 'coral' },
  { kind: 'record-broken',      label: "Ronaldo's record",         pick: '9 World Cup goals. The record is his alone.',  detail: "The penalty against DR Congo gave him the men's all-time World Cup scoring record — nine goals across five tournaments. He milked every second of it. Portugal are top of Group K. At 41, the farewell is going exactly as he scripted.", tone: 'coral' },
  ...
  { kind: 'cruel-arithmetic',   label: "Son's elimination spiral", pick: 'Korea Republic on the brink.',                 detail: "0–1 to Czechia in MD1. 0–2 to Mexico in MD2. Son Heung-min has not scored in either game. Korea are on the verge of elimination entering Matchday 3. The captain who carried a nation for a decade faces the most difficult 90 minutes of his career.", tone: 'coral' },
];
