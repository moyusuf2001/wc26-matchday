...
// Homepage tournament-themes editorial layer.
  ...
  'NOR-FRA': {
    ...
    upset: 'live-underdog-chance',
    watch: [
      { h: "Haaland vs the French defensive line", p: "Upamecano and Konaté are elite centre-backs but Haaland's movement, physicality and first-touch finishing have troubled better defenders. The aerial duel at set pieces is Norway's clearest route." },
  ...
  'POR-COL': {
    ...
    groupContext: { label: 'Group K: Portugal in danger', text: "Portugal drew 1–1 with Congo in MD1. A second failure to win would be one of the tournament's greatest group-stage shocks. Colombia beat Uzbekistan in MD1 and are in a strong position, giving them the ability to go for this game." },
    ...
    watch: [
      ...
      { h: "Luis Díaz vs the Portuguese right side", p: "Díaz's pace on the left in behind Portugal's right-back is Colombia's clearest route to the goal. Bayern form translating to World Cup stage." },
    ...
    flip: { trigger: 'If Colombia score first from a transition', outcome: "Portugal chasing a goal against a compact Colombia side is the scenario that most threatens Ronaldo's final World Cup. Martinez has to change everything and Ronaldo becomes the gamble." },
    ...
    spotlight: [
      ...
      { code: 'COL', name: 'Luis Díaz', role: 'The pace weapon', why: "Bayern Munich's dynamic left winger is Colombia's most dangerous attacking weapon. His ability to run in behind and create chances from nothing is the one thing that genuinely frightens Portugal's defence.", watch: "When he starts wide left and angles his run inside — this is where he shoots and scores. Portugal's right-back must track him all game." },
    ],
  },

export const TOURNAMENT_THEMES = [
  { kind: 'player-delivered',   label: 'Haaland delivers',            pick: '4–1 to Iraq. Norway meant business.',              detail: "Norway 4–1 Iraq. Haaland had never scored at a World Cup before Thursday. He left with a brace and a statement. After 16 qualifying goals and years of anticipation, the world's best number nine chose the biggest stage to announce himself. Norway top Group I and they are not done.", tone: 'teal' },
  { kind: 'living-legend',      label: "Messi's hattrick",            pick: 'That long-range goal. In a World Cup. At 38.',      detail: "Argentina vs Algeria. Messi scored a hat-trick: two clinical finishes and then the third, an outrageous strike from outside the box that left the whole stadium silent for a second before it erupted. The defending champions look capable of doing this again.", tone: 'gold' },
  { kind: 'best-player',        label: "Germany's surprise weapon",   pick: 'Undav: 3 goals, 2 assists. Nobody saw this coming.', detail: "Denis Undav has been Germany's most decisive player at this tournament. 3 goals and 2 assists across two games. Wirtz and Musiala get the headlines but Undav is the one putting the ball in the net. Germany have won both games and their ceiling looks frightening.", tone: 'gold' },
  { kind: 'favourite-stumble',  label: 'Spain: stumble then statement', pick: '0–0 Cape Verde. Then 4–0 Saudi Arabia.',           detail: "Spain drew 0–0 with debutants Cape Verde in MD1, the worst result of Matchday 1 for any title favourite. The response in MD2 was ferocious: 4–0 Saudi Arabia, no mercy shown. The favourites are back. But that Cape Verde draw is a warning they will have to answer for later.", tone: 'coral' },
  { kind: 'upset-artist',       label: 'Atlas Lions strike again',    pick: 'Drew with Brazil. Beat Scotland. Group C is theirs.', detail: "Morocco held Brazil to a 1–1 draw in MD1, the Atlas Lions refusing to be anyone's opening-night stage. Then 1–0 over Scotland in MD2. Six points from six, top of Group C, making every opponent uncomfortable. The 2022 semifinalists are not done.", tone: 'coral' },
  { kind: 'record-pressure',    label: "Ronaldo: still waiting",      pick: 'Portugal drew 1–1 with Congo. Not the script.',    detail: "Portugal were held to a 1–1 draw by DR Congo in MD1. Ronaldo did not score. At 41 and at his last World Cup, a draw with Congo is not the farewell narrative he had in mind. Portugal need to be better and Ronaldo needs a goal.", tone: 'coral' },
  ...
  { kind: 'golden-boot',        label: 'Golden Boot race',            pick: 'Messi and Undav. Three goals each.',                detail: "Two matchdays in and the top of the scoring charts belongs to two players nobody expected to share it. Messi with his hat-trick against Algeria, Undav with 3 goals across two games for Germany. The Golden Boot race is already a storyline.", tone: 'teal' },
];
